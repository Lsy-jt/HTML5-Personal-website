layui.use(['element', 'jquery', 'form', 'layedit'], function () {
    ...
    form.on('submit(formLeaveMessage)', function (data) {
        ...
        setTimeout(function () {
            ...
            var dateq = new Date();
            var date = dateq.getFullYear() + "-" + (dateq.getMonth() + 1) + "-" + dateq.getDate() + "  " + dateq.getHours() + ":" + dateq.getMinutes() + ":" + dateq.getSeconds();
            var html = '<li><div class="comment-parent"><img src="../images/a.jpg"/><div class="info"><span class="username">' + name + '</span></div><div class="content">' + content + '</div><p class="info info-footer"><span class="time">' + date + '</span><a class="btn-reply"href="javascript:;" onclick="btnReplyClick(this)">回复</a></p></div><!--回复表单默认隐藏--><div class="replycontainer layui-hide"><form class="layui-form"action=""><div class="layui-form-item"><textarea name="replyContent"lay-verify="replyContent"placeholder="请输入回复内容"class="layui-textarea"style="min-height:80px;"></textarea></div><div class="layui-form-item"><button class="layui-btn layui-btn-mini"lay-submit="formReply"lay-filter="formReply">提交</button></div></form></div></li><br/><hr/><br/>';
    ...
    form.on('submit(formReply)', function (data) {
        ...
        setTimeout(function () {
            ...
            var html = '<div class="comment-child"><img src="../images/lsy.jpg"/><div class="info">><span>' + content + '</span></div><p class="info"><span class="time">2019-05-18 18:26</span></p></div>';
